...
int gen_baseline()
{
	TFile *f = new TFile("cfRatesBaseline.root", "RECREATE");
	vector<string> path_data;
	path_data.clear();
	path_data.push_back( "../Fit/fit_data_baseline_80_100_20_20.txt" );
	path_data.push_back( "../Fit/fit_data_baseline_80_100_15_15.txt" );
	path_data.push_back( "../Fit/fit_data_baseline_80_100_25_25.txt" );
	path_data.push_back( "../Fit/fit_data_baseline_75_105_20_20.txt" );
	path_data.push_back( "../Fit/fit_data_baseline_80_100_0_0.txt" );
	...
	path_mc.clear();
	path_mc.push_back( "../Fit/fit_mc_baseline_80_100_0_0.txt" );
	path_mc.push_back( "../FitPlots/mc_baseline_truth.txt" );
